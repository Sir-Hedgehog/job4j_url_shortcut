...
import static ru.job4j.url.filter.AuthenticationFilter.HEADER_STRING;
import static ru.job4j.url.filter.AuthenticationFilter.SECRET;
import static ru.job4j.url.filter.AuthenticationFilter.TOKEN_PREFIX;
